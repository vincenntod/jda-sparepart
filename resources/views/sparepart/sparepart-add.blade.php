...
<div class="container">
    <h2>Tambah Data</h2>
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="name_sparepart" name="name_sparepart" required>
        </div>
        <div class="mb-3">
            <label for="year_production" class="form-label">Price</label>
        ...
        $('#submit').on('click', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    AjaxCreate(url, data, "/sparepart-menu")
                } else {
